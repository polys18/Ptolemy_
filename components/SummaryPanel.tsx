...
export const SummaryPanel: React.FC<SummaryPanelProps> = ({ isOpen, onClose }) => {
  if (!isOpen) return null;

  return (
    <div className="w-96 h-full bg-gis-900 flex flex-col border-l border-gis-800 flex-shrink-0 z-20 shadow-xl">
      {/* Header */}
      <div className="p-4 border-b border-gis-800 flex items-center justify-between bg-gis-900">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-bold text-lg text-white tracking-tight">Article</h2>
        </div>
        <button
          onClick={onClose}
          className="p-1.5 hover:bg-gis-700 rounded text-gray-400 hover:text-white transition-colors"
        >
          <X className="w-4 h-4" />
        </button>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 custom-scrollbar space-y-6">
        ...
        {/* Methodology */}
        <div>
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-2">Methodology</h3>
          <p className="text-sm text-gray-300 leading-relaxed">
        ...
        <div>
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-2">Building the Screens</h3>
        ...
        <div>
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-2">Building the Criteria</h3>
          
          <div className="mb-3">
            <h4 className="text-xs font-semibold text-brand-400 mb-1.5">Infrastructure-Related Criteria</h4>
            <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <div className="mb-3">
            <h4 className="text-xs font-semibold text-brand-400 mb-1.5">Co-locating with Gas</h4>
            <p className="text-sm text-gray-300 leading-relaxed mb-2">
          ...
          <div className="mb-3">
            <h4 className="text-xs font-semibold text-brand-400 mb-1.5">Urban Areas</h4>
            <p className="text-sm text-gray-300 leading-relaxed">
        ...
        {/* Limitations */}
        <div>
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-2">Limitations</h3>
          <p className="text-sm text-gray-300 leading-relaxed">
          ...
          <p className="text-sm text-gray-300 leading-relaxed mt-2">
            <strong className="text-gray-200">Parcel level data:</strong> To properly identify the right parcels one needs to know the if a parcel of land is available for purchase. That data while it exists is extremely expensive and would cost tens of thousands of dollars for purchase.
          </p>
        </div>
      </div>
    </div>
